...
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="index.html" class="logo d-flex align-items-center"> <img
			...
			class="d-none d-lg-block">Member Template</span>
	...
	<div class="search-bar">
		<form class="search-form d-flex align-items-center" method="GET"
			action="memberView">
			<input type="text" name="fId" placeholder="회원검색"
...
<ul class="d-flex align-items-center">
			...
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img
					...
					class="d-none d-md-block dropdown-toggle ps-2">${loginId}</span>
				...
				<ul
					...
					<li class="dropdown-header">
						<h6>${loginId}</h6> <span>Web Designer</span>
					</li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="memberView?fId=${loginId}"> <i class="bi bi-person"></i> <span>My
								Profile</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
			...
			<c:otherwise>
				<!-- 로그인 페이지로 이동 -->
				<a href="loginForm"><span class="d-none d-md-block dropdown-toggle ps-2">Login</span></a>
			</c:otherwise>
		</c:choose>
